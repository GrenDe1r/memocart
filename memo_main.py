...
def testlist():
    frm = Question('Зірка', 'star', 'brawl stars', 'rats', 'arst')
    questions_listmodel.form_list.append(frm)
    frm = Question('Лампочка', 'bulb', 'dalb', 'buld', 'baet')
    questions_listmodel.form_list.append(frm)
    frm = Question('Вікно', 'window', 'wind', 'wendow', 'windaw')
    questions_listmodel.form_list.append(frm)
    frm = Question('Автомобіль', 'car', 'cear', 'cal', 'cur')
    questions_listmodel.form_list.append(frm)
    frm = Question('Яблуко', 'apple', 'application', 'pinapple', 'apply')
    questions_listmodel.form_list.append(frm)
    frm = Question('Перекладач', 'translator', 'terminator', 'perekladach', 'transformer')
    questions_listmodel.form_list.append(frm)
